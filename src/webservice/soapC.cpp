...
{	(void)type;
	...
	case SOAP_TYPE_mons__ExeCloseSMSResponse:
		return soap_in_mons__ExeCloseSMSResponse(soap, NULL, NULL, "mons:ExeCloseSMSResponse");
	case SOAP_TYPE_mons__ExeSwitchSMSToOtherDelay:
		return soap_in_mons__ExeSwitchSMSToOtherDelay(soap, NULL, NULL, "mons:ExeSwitchSMSToOtherDelay");
	case SOAP_TYPE_mons__ExeSwitchSMSToOtherDelayResponse:
		return soap_in_mons__ExeSwitchSMSToOtherDelayResponse(soap, NULL, NULL, "mons:ExeSwitchSMSToOtherDelayResponse");
	case SOAP_TYPE_mons__ExeSwitchSMSToOther:
		return soap_in_mons__ExeSwitchSMSToOther(soap, NULL, NULL, "mons:ExeSwitchSMSToOther");
	case SOAP_TYPE_mons__ExeSwitchSMSToOtherResponse:
		return soap_in_mons__ExeSwitchSMSToOtherResponse(soap, NULL, NULL, "mons:ExeSwitchSMSToOtherResponse");
	case SOAP_TYPE_mons__ExeSwitchTMSToOther:
		return soap_in_mons__ExeSwitchTMSToOther(soap, NULL, NULL, "mons:ExeSwitchTMSToOther");
	case SOAP_TYPE_mons__ExeSwitchTMSToOtherResponse:
		return soap_in_mons__ExeSwitchTMSToOtherResponse(soap, NULL, NULL, "mons:ExeSwitchTMSToOtherResponse");
	...
	case SOAP_TYPE_mons__GetEthStateResponse:
		return soap_in_mons__GetEthStateResponse(soap, NULL, NULL, "mons:GetEthStateResponse");
	...
	case SOAP_TYPE_mons__GetSMSStateResponse:
		return soap_in_mons__GetSMSStateResponse(soap, NULL, NULL, "mons:GetSMSStateResponse");
	...
	*type = 0;
	...
	{	const char *t = soap->type;
		...
		{	*type = SOAP_TYPE_mons__ExeCloseSMS;
			return soap_in_mons__ExeCloseSMS(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "mons:ExeCloseSMSResponse"))
		{	*type = SOAP_TYPE_mons__ExeCloseSMSResponse;
			return soap_in_mons__ExeCloseSMSResponse(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "mons:ExeSwitchSMSToOtherDelay"))
		{	*type = SOAP_TYPE_mons__ExeSwitchSMSToOtherDelay;
			return soap_in_mons__ExeSwitchSMSToOtherDelay(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "mons:ExeSwitchSMSToOtherDelayResponse"))
		{	*type = SOAP_TYPE_mons__ExeSwitchSMSToOtherDelayResponse;
			return soap_in_mons__ExeSwitchSMSToOtherDelayResponse(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "mons:ExeSwitchSMSToOther"))
		{	*type = SOAP_TYPE_mons__ExeSwitchSMSToOther;
			return soap_in_mons__ExeSwitchSMSToOther(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "mons:ExeSwitchSMSToOtherResponse"))
		{	*type = SOAP_TYPE_mons__ExeSwitchSMSToOtherResponse;
			return soap_in_mons__ExeSwitchSMSToOtherResponse(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "mons:ExeSwitchTMSToOther"))
		{	*type = SOAP_TYPE_mons__ExeSwitchTMSToOther;
			return soap_in_mons__ExeSwitchTMSToOther(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "mons:ExeSwitchTMSToOtherResponse"))
		{	*type = SOAP_TYPE_mons__ExeSwitchTMSToOtherResponse;
			return soap_in_mons__ExeSwitchTMSToOtherResponse(soap, NULL, NULL, NULL);
		}
		...
		if (!soap_match_tag(soap, t, "mons:GetEthStateResponse"))
		{	*type = SOAP_TYPE_mons__GetEthStateResponse;
			return soap_in_mons__GetEthStateResponse(soap, NULL, NULL, NULL);
		}
		...
		if (!soap_match_tag(soap, t, "mons:GetSMSStateResponse"))
		{	*type = SOAP_TYPE_mons__GetSMSStateResponse;
			return soap_in_mons__GetSMSStateResponse(soap, NULL, NULL, NULL);
		}
...
{	(void)tag;
	...
	case SOAP_TYPE_mons__ExeCloseSMSResponse:
		return soap_out_mons__ExeCloseSMSResponse(soap, tag, id, (const struct mons__ExeCloseSMSResponse *)ptr, "mons:ExeCloseSMSResponse");
	case SOAP_TYPE_mons__ExeSwitchSMSToOtherDelay:
		return soap_out_mons__ExeSwitchSMSToOtherDelay(soap, tag, id, (const struct mons__ExeSwitchSMSToOtherDelay *)ptr, "mons:ExeSwitchSMSToOtherDelay");
	case SOAP_TYPE_mons__ExeSwitchSMSToOtherDelayResponse:
		return soap_out_mons__ExeSwitchSMSToOtherDelayResponse(soap, tag, id, (const struct mons__ExeSwitchSMSToOtherDelayResponse *)ptr, "mons:ExeSwitchSMSToOtherDelayResponse");
	case SOAP_TYPE_mons__ExeSwitchSMSToOther:
		return soap_out_mons__ExeSwitchSMSToOther(soap, tag, id, (const struct mons__ExeSwitchSMSToOther *)ptr, "mons:ExeSwitchSMSToOther");
	case SOAP_TYPE_mons__ExeSwitchSMSToOtherResponse:
		return soap_out_mons__ExeSwitchSMSToOtherResponse(soap, tag, id, (const struct mons__ExeSwitchSMSToOtherResponse *)ptr, "mons:ExeSwitchSMSToOtherResponse");
	case SOAP_TYPE_mons__ExeSwitchTMSToOther:
		return soap_out_mons__ExeSwitchTMSToOther(soap, tag, id, (const struct mons__ExeSwitchTMSToOther *)ptr, "mons:ExeSwitchTMSToOther");
	case SOAP_TYPE_mons__ExeSwitchTMSToOtherResponse:
		return soap_out_mons__ExeSwitchTMSToOtherResponse(soap, tag, id, (const struct mons__ExeSwitchTMSToOtherResponse *)ptr, "mons:ExeSwitchTMSToOtherResponse");
	case SOAP_TYPE_mons__GetWorkState_USCORECS:
	...
	case SOAP_TYPE_mons__GetEthStateResponse:
		return soap_out_mons__GetEthStateResponse(soap, tag, id, (const struct mons__GetEthStateResponse *)ptr, "mons:GetEthStateResponse");
	case SOAP_TYPE_mons__ethstate:
	...
	case SOAP_TYPE_mons__GetSMSStateResponse:
		return soap_out_mons__GetSMSStateResponse(soap, tag, id, (const struct mons__GetSMSStateResponse *)ptr, "mons:GetSMSStateResponse");
	case SOAP_TYPE_mons__SMSState:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE_mons__ExeCloseSMS:
		...
		break;
	case SOAP_TYPE_mons__ExeCloseSMSResponse:
		soap_serialize_mons__ExeCloseSMSResponse(soap, (const struct mons__ExeCloseSMSResponse *)ptr);
		break;
	case SOAP_TYPE_mons__ExeSwitchSMSToOtherDelay:
		soap_serialize_mons__ExeSwitchSMSToOtherDelay(soap, (const struct mons__ExeSwitchSMSToOtherDelay *)ptr);
		break;
	case SOAP_TYPE_mons__ExeSwitchSMSToOtherDelayResponse:
		soap_serialize_mons__ExeSwitchSMSToOtherDelayResponse(soap, (const struct mons__ExeSwitchSMSToOtherDelayResponse *)ptr);
		break;
	case SOAP_TYPE_mons__ExeSwitchSMSToOther:
		soap_serialize_mons__ExeSwitchSMSToOther(soap, (const struct mons__ExeSwitchSMSToOther *)ptr);
		break;
	case SOAP_TYPE_mons__ExeSwitchSMSToOtherResponse:
		soap_serialize_mons__ExeSwitchSMSToOtherResponse(soap, (const struct mons__ExeSwitchSMSToOtherResponse *)ptr);
		break;
	case SOAP_TYPE_mons__ExeSwitchTMSToOther:
		soap_serialize_mons__ExeSwitchTMSToOther(soap, (const struct mons__ExeSwitchTMSToOther *)ptr);
		break;
	case SOAP_TYPE_mons__ExeSwitchTMSToOtherResponse:
		soap_serialize_mons__ExeSwitchTMSToOtherResponse(soap, (const struct mons__ExeSwitchTMSToOtherResponse *)ptr);
		break;
	case SOAP_TYPE_mons__GetWorkState_USCORECS:
	...
	case SOAP_TYPE_mons__GetEthState:
		...
		break;
	case SOAP_TYPE_mons__GetEthStateResponse:
		soap_serialize_mons__GetEthStateResponse(soap, (const struct mons__GetEthStateResponse *)ptr);
		break;
	case SOAP_TYPE_mons__ethstate:
	...
	case SOAP_TYPE_mons__GetSMSState:
		...
		break;
	case SOAP_TYPE_mons__GetSMSStateResponse:
		soap_serialize_mons__GetSMSStateResponse(soap, (const struct mons__GetSMSStateResponse *)ptr);
		break;
	case SOAP_TYPE_mons__SMSState:
...
{	(void)type;
	...
	case SOAP_TYPE_mons__GetSMSStateResponse:
		return (void*)soap_instantiate_mons__GetSMSStateResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE_mons__GetSMSState:
	...
	case SOAP_TYPE_mons__GetEthStateResponse:
		return (void*)soap_instantiate_mons__GetEthStateResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE_mons__GetEthState:
	...
	case SOAP_TYPE_mons__ExeSwitchTMSToOtherResponse:
		return (void*)soap_instantiate_mons__ExeSwitchTMSToOtherResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE_mons__ExeSwitchTMSToOther:
		return (void*)soap_instantiate_mons__ExeSwitchTMSToOther(soap, -1, type, arrayType, n);
	case SOAP_TYPE_mons__ExeSwitchSMSToOtherResponse:
		return (void*)soap_instantiate_mons__ExeSwitchSMSToOtherResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE_mons__ExeSwitchSMSToOther:
		return (void*)soap_instantiate_mons__ExeSwitchSMSToOther(soap, -1, type, arrayType, n);
	case SOAP_TYPE_mons__ExeSwitchSMSToOtherDelayResponse:
		return (void*)soap_instantiate_mons__ExeSwitchSMSToOtherDelayResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE_mons__ExeSwitchSMSToOtherDelay:
		return (void*)soap_instantiate_mons__ExeSwitchSMSToOtherDelay(soap, -1, type, arrayType, n);
	case SOAP_TYPE_mons__ExeCloseSMSResponse:
...
#endif
	case SOAP_TYPE_std__vectorTemplateOfmons__ethstate:
		return (void*)soap_instantiate_std__vectorTemplateOfmons__ethstate(soap, -1, type, arrayType, n);
	case SOAP_TYPE_std__vectorTemplateOfint:
		return (void*)soap_instantiate_std__vectorTemplateOfint(soap, -1, type, arrayType, n);
	case SOAP_TYPE_std__vectorTemplateOfmons__SMSState:
		return (void*)soap_instantiate_std__vectorTemplateOfmons__SMSState(soap, -1, type, arrayType, n);
	}
	return NULL;
}
...
{	switch (p->type)
	...
	case SOAP_TYPE_mons__GetSMSStateResponse:
		if (p->size < 0)
			SOAP_DELETE((struct mons__GetSMSStateResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct mons__GetSMSStateResponse*)p->ptr);
		break;
	case SOAP_TYPE_mons__GetSMSState:
		if (p->size < 0)
	...
	case SOAP_TYPE_mons__GetEthStateResponse:
		if (p->size < 0)
			SOAP_DELETE((struct mons__GetEthStateResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct mons__GetEthStateResponse*)p->ptr);
		break;
	case SOAP_TYPE_mons__GetEthState:
		if (p->size < 0)
	...
	case SOAP_TYPE_mons__ExeSwitchTMSToOtherResponse:
		if (p->size < 0)
			SOAP_DELETE((struct mons__ExeSwitchTMSToOtherResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct mons__ExeSwitchTMSToOtherResponse*)p->ptr);
		break;
	case SOAP_TYPE_mons__ExeSwitchTMSToOther:
		if (p->size < 0)
			SOAP_DELETE((struct mons__ExeSwitchTMSToOther*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct mons__ExeSwitchTMSToOther*)p->ptr);
		break;
	case SOAP_TYPE_mons__ExeSwitchSMSToOtherResponse:
		if (p->size < 0)
			SOAP_DELETE((struct mons__ExeSwitchSMSToOtherResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct mons__ExeSwitchSMSToOtherResponse*)p->ptr);
		break;
	case SOAP_TYPE_mons__ExeSwitchSMSToOther:
		if (p->size < 0)
			SOAP_DELETE((struct mons__ExeSwitchSMSToOther*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct mons__ExeSwitchSMSToOther*)p->ptr);
		break;
	case SOAP_TYPE_mons__ExeSwitchSMSToOtherDelayResponse:
		if (p->size < 0)
			SOAP_DELETE((struct mons__ExeSwitchSMSToOtherDelayResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct mons__ExeSwitchSMSToOtherDelayResponse*)p->ptr);
		break;
	case SOAP_TYPE_mons__ExeSwitchSMSToOtherDelay:
		if (p->size < 0)
			SOAP_DELETE((struct mons__ExeSwitchSMSToOtherDelay*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct mons__ExeSwitchSMSToOtherDelay*)p->ptr);
		break;
	case SOAP_TYPE_mons__ExeCloseSMSResponse:
		if (p->size < 0)
			SOAP_DELETE((struct mons__ExeCloseSMSResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct mons__ExeCloseSMSResponse*)p->ptr);
		break;
	case SOAP_TYPE_mons__ExeCloseSMS:
		if (p->size < 0)
	...
	case SOAP_TYPE_std__vectorTemplateOfmons__ethstate:
		if (p->size < 0)
			SOAP_DELETE((std::vector<struct mons__ethstate >*)p->ptr);
		else
			SOAP_DELETE_ARRAY((std::vector<struct mons__ethstate >*)p->ptr);
		break;
	case SOAP_TYPE_std__vectorTemplateOfint:
		if (p->size < 0)
	...
	case SOAP_TYPE_std__vectorTemplateOfmons__SMSState:
		if (p->size < 0)
			SOAP_DELETE((std::vector<struct mons__SMSState >*)p->ptr);
		else
			SOAP_DELETE_ARRAY((std::vector<struct mons__SMSState >*)p->ptr);
		break;
...
#endif
{
	...
	case SOAP_TYPE_std__vectorTemplateOfmons__ethstate:
		...
		(*(std::vector<struct mons__ethstate >*)p)[len] = *(struct mons__ethstate *)q;
		break;
	case SOAP_TYPE_std__vectorTemplateOfint:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Container soap_container_insert type = %d in %d location = %p object = %p len = %lu\n", st, tt, p, q, (unsigned long)len));
	...
	case SOAP_TYPE_std__vectorTemplateOfmons__SMSState:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Container soap_container_insert type = %d in %d location = %p object = %p len = %lu\n", st, tt, p, q, (unsigned long)len));
		(*(std::vector<struct mons__SMSState >*)p)[len] = *(struct mons__SMSState *)q;
		break;
	default:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_mons__ExeCloseSMS(struct soap *soap, const struct mons__ExeCloseSMS *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_std__string(soap, &a->strHallID);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_mons__ExeCloseSMS(struct soap *soap, const char *tag, int id, const struct mons__ExeCloseSMS *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_mons__ExeCloseSMS), type))
		return soap->error;
	if (soap_out_std__string(soap, "strHallID", -1, &a->strHallID, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
SOAP_FMAC3 struct mons__ExeCloseSMS * SOAP_FMAC4 soap_in_mons__ExeCloseSMS(struct soap *soap, const char *tag, struct mons__ExeCloseSMS *a, const char *type)
{
	size_t soap_flag_strHallID = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct mons__ExeCloseSMS *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE_mons__ExeCloseSMS, sizeof(struct mons__ExeCloseSMS), soap->type, soap->arrayType);
	if (!a)
		return NULL;
	soap_default_mons__ExeCloseSMS(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct mons__ExeCloseSMS *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_mons__ExeCloseSMS, 0, sizeof(struct mons__ExeCloseSMS), 0, soap_copy_mons__ExeCloseSMS);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_strHallID > 0))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_mons__ExeCloseSMS(struct soap *soap, const struct mons__ExeCloseSMS *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_mons__ExeCloseSMS);
	if (soap_out_mons__ExeCloseSMS(soap, tag?tag:"mons:ExeCloseSMS", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct mons__ExeCloseSMS * SOAP_FMAC4 soap_get_mons__ExeCloseSMS(struct soap *soap, struct mons__ExeCloseSMS *p, const char *tag, const char *type)
{
	if ((p = soap_in_mons__ExeCloseSMS(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct mons__ExeCloseSMS * SOAP_FMAC2 soap_instantiate_mons__ExeCloseSMS(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_mons__ExeCloseSMS(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_mons__ExeCloseSMS, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct mons__ExeCloseSMS);
		if (size)
			*size = sizeof(struct mons__ExeCloseSMS);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct mons__ExeCloseSMS, n);
		if (size)
			*size = n * sizeof(struct mons__ExeCloseSMS);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct mons__ExeCloseSMS*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_mons__ExeCloseSMS(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct mons__ExeCloseSMS %p -> %p\n", q, p));
	*(struct mons__ExeCloseSMS*)p = *(struct mons__ExeCloseSMS*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_mons__ExeCloseSMSResponse(struct soap *soap, struct mons__ExeCloseSMSResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_int(soap, &a->ret);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_mons__ExeCloseSMSResponse(struct soap *soap, const struct mons__ExeCloseSMSResponse *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
#endif
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_mons__ExeCloseSMSResponse(struct soap *soap, const char *tag, int id, const struct mons__ExeCloseSMSResponse *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_mons__ExeCloseSMSResponse), type))
		return soap->error;
	if (soap_out_int(soap, "ret", -1, &a->ret, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
SOAP_FMAC3 struct mons__ExeCloseSMSResponse * SOAP_FMAC4 soap_in_mons__ExeCloseSMSResponse(struct soap *soap, const char *tag, struct mons__ExeCloseSMSResponse *a, const char *type)
{
	size_t soap_flag_ret = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct mons__ExeCloseSMSResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_mons__ExeCloseSMSResponse, sizeof(struct mons__ExeCloseSMSResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_mons__ExeCloseSMSResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct mons__ExeCloseSMSResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_mons__ExeCloseSMSResponse, 0, sizeof(struct mons__ExeCloseSMSResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_ret > 0))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_mons__ExeCloseSMSResponse(struct soap *soap, const struct mons__ExeCloseSMSResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_mons__ExeCloseSMSResponse);
	if (soap_out_mons__ExeCloseSMSResponse(soap, tag?tag:"mons:ExeCloseSMSResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct mons__ExeCloseSMSResponse * SOAP_FMAC4 soap_get_mons__ExeCloseSMSResponse(struct soap *soap, struct mons__ExeCloseSMSResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_mons__ExeCloseSMSResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct mons__ExeCloseSMSResponse * SOAP_FMAC2 soap_instantiate_mons__ExeCloseSMSResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_mons__ExeCloseSMSResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_mons__ExeCloseSMSResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct mons__ExeCloseSMSResponse);
		if (size)
			*size = sizeof(struct mons__ExeCloseSMSResponse);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct mons__ExeCloseSMSResponse, n);
		if (size)
			*size = n * sizeof(struct mons__ExeCloseSMSResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct mons__ExeCloseSMSResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_mons__ExeCloseSMSResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct mons__ExeCloseSMSResponse %p -> %p\n", q, p));
	*(struct mons__ExeCloseSMSResponse*)p = *(struct mons__ExeCloseSMSResponse*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_mons__ExeSwitchSMSToOtherDelay(struct soap *soap, struct mons__ExeSwitchSMSToOtherDelay *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_std__string(soap, &a->strHallID);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_mons__ExeSwitchSMSToOtherDelay(struct soap *soap, const struct mons__ExeSwitchSMSToOtherDelay *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_std__string(soap, &a->strHallID);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_mons__ExeSwitchSMSToOtherDelay(struct soap *soap, const char *tag, int id, const struct mons__ExeSwitchSMSToOtherDelay *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_mons__ExeSwitchSMSToOtherDelay), type))
		return soap->error;
	if (soap_out_std__string(soap, "strHallID", -1, &a->strHallID, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
SOAP_FMAC3 struct mons__ExeSwitchSMSToOtherDelay * SOAP_FMAC4 soap_in_mons__ExeSwitchSMSToOtherDelay(struct soap *soap, const char *tag, struct mons__ExeSwitchSMSToOtherDelay *a, const char *type)
{
	size_t soap_flag_strHallID = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct mons__ExeSwitchSMSToOtherDelay *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE_mons__ExeSwitchSMSToOtherDelay, sizeof(struct mons__ExeSwitchSMSToOtherDelay), soap->type, soap->arrayType);
	if (!a)
		return NULL;
	soap_default_mons__ExeSwitchSMSToOtherDelay(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct mons__ExeSwitchSMSToOtherDelay *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_mons__ExeSwitchSMSToOtherDelay, 0, sizeof(struct mons__ExeSwitchSMSToOtherDelay), 0, soap_copy_mons__ExeSwitchSMSToOtherDelay);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_strHallID > 0))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_mons__ExeSwitchSMSToOtherDelay(struct soap *soap, const struct mons__ExeSwitchSMSToOtherDelay *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_mons__ExeSwitchSMSToOtherDelay);
	if (soap_out_mons__ExeSwitchSMSToOtherDelay(soap, tag?tag:"mons:ExeSwitchSMSToOtherDelay", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct mons__ExeSwitchSMSToOtherDelay * SOAP_FMAC4 soap_get_mons__ExeSwitchSMSToOtherDelay(struct soap *soap, struct mons__ExeSwitchSMSToOtherDelay *p, const char *tag, const char *type)
{
	if ((p = soap_in_mons__ExeSwitchSMSToOtherDelay(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct mons__ExeSwitchSMSToOtherDelay * SOAP_FMAC2 soap_instantiate_mons__ExeSwitchSMSToOtherDelay(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_mons__ExeSwitchSMSToOtherDelay(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_mons__ExeSwitchSMSToOtherDelay, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct mons__ExeSwitchSMSToOtherDelay);
		if (size)
			*size = sizeof(struct mons__ExeSwitchSMSToOtherDelay);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct mons__ExeSwitchSMSToOtherDelay, n);
		if (size)
			*size = n * sizeof(struct mons__ExeSwitchSMSToOtherDelay);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct mons__ExeSwitchSMSToOtherDelay*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_mons__ExeSwitchSMSToOtherDelay(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct mons__ExeSwitchSMSToOtherDelay %p -> %p\n", q, p));
	*(struct mons__ExeSwitchSMSToOtherDelay*)p = *(struct mons__ExeSwitchSMSToOtherDelay*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_mons__ExeSwitchSMSToOtherDelayResponse(struct soap *soap, struct mons__ExeSwitchSMSToOtherDelayResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_int(soap, &a->ret);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_mons__ExeSwitchSMSToOtherDelayResponse(struct soap *soap, const struct mons__ExeSwitchSMSToOtherDelayResponse *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
#endif
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_mons__ExeSwitchSMSToOtherDelayResponse(struct soap *soap, const char *tag, int id, const struct mons__ExeSwitchSMSToOtherDelayResponse *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_mons__ExeSwitchSMSToOtherDelayResponse), type))
		return soap->error;
	if (soap_out_int(soap, "ret", -1, &a->ret, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
SOAP_FMAC3 struct mons__ExeSwitchSMSToOtherDelayResponse * SOAP_FMAC4 soap_in_mons__ExeSwitchSMSToOtherDelayResponse(struct soap *soap, const char *tag, struct mons__ExeSwitchSMSToOtherDelayResponse *a, const char *type)
{
	size_t soap_flag_ret = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct mons__ExeSwitchSMSToOtherDelayResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_mons__ExeSwitchSMSToOtherDelayResponse, sizeof(struct mons__ExeSwitchSMSToOtherDelayResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_mons__ExeSwitchSMSToOtherDelayResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct mons__ExeSwitchSMSToOtherDelayResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_mons__ExeSwitchSMSToOtherDelayResponse, 0, sizeof(struct mons__ExeSwitchSMSToOtherDelayResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_ret > 0))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_mons__ExeSwitchSMSToOtherDelayResponse(struct soap *soap, const struct mons__ExeSwitchSMSToOtherDelayResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_mons__ExeSwitchSMSToOtherDelayResponse);
	if (soap_out_mons__ExeSwitchSMSToOtherDelayResponse(soap, tag?tag:"mons:ExeSwitchSMSToOtherDelayResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct mons__ExeSwitchSMSToOtherDelayResponse * SOAP_FMAC4 soap_get_mons__ExeSwitchSMSToOtherDelayResponse(struct soap *soap, struct mons__ExeSwitchSMSToOtherDelayResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_mons__ExeSwitchSMSToOtherDelayResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct mons__ExeSwitchSMSToOtherDelayResponse * SOAP_FMAC2 soap_instantiate_mons__ExeSwitchSMSToOtherDelayResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_mons__ExeSwitchSMSToOtherDelayResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_mons__ExeSwitchSMSToOtherDelayResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct mons__ExeSwitchSMSToOtherDelayResponse);
		if (size)
			*size = sizeof(struct mons__ExeSwitchSMSToOtherDelayResponse);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct mons__ExeSwitchSMSToOtherDelayResponse, n);
		if (size)
			*size = n * sizeof(struct mons__ExeSwitchSMSToOtherDelayResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct mons__ExeSwitchSMSToOtherDelayResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_mons__ExeSwitchSMSToOtherDelayResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct mons__ExeSwitchSMSToOtherDelayResponse %p -> %p\n", q, p));
	*(struct mons__ExeSwitchSMSToOtherDelayResponse*)p = *(struct mons__ExeSwitchSMSToOtherDelayResponse*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_mons__ExeSwitchSMSToOther(struct soap *soap, struct mons__ExeSwitchSMSToOther *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_std__string(soap, &a->strHallID);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_mons__ExeSwitchSMSToOther(struct soap *soap, const struct mons__ExeSwitchSMSToOther *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_std__string(soap, &a->strHallID);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_mons__ExeSwitchSMSToOther(struct soap *soap, const char *tag, int id, const struct mons__ExeSwitchSMSToOther *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_mons__ExeSwitchSMSToOther), type))
		return soap->error;
	if (soap_out_std__string(soap, "strHallID", -1, &a->strHallID, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
SOAP_FMAC3 struct mons__ExeSwitchSMSToOther * SOAP_FMAC4 soap_in_mons__ExeSwitchSMSToOther(struct soap *soap, const char *tag, struct mons__ExeSwitchSMSToOther *a, const char *type)
{
	size_t soap_flag_strHallID = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct mons__ExeSwitchSMSToOther *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE_mons__ExeSwitchSMSToOther, sizeof(struct mons__ExeSwitchSMSToOther), soap->type, soap->arrayType);
	if (!a)
		return NULL;
	soap_default_mons__ExeSwitchSMSToOther(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct mons__ExeSwitchSMSToOther *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_mons__ExeSwitchSMSToOther, 0, sizeof(struct mons__ExeSwitchSMSToOther), 0, soap_copy_mons__ExeSwitchSMSToOther);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_strHallID > 0))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_mons__ExeSwitchSMSToOther(struct soap *soap, const struct mons__ExeSwitchSMSToOther *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_mons__ExeSwitchSMSToOther);
	if (soap_out_mons__ExeSwitchSMSToOther(soap, tag?tag:"mons:ExeSwitchSMSToOther", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct mons__ExeSwitchSMSToOther * SOAP_FMAC4 soap_get_mons__ExeSwitchSMSToOther(struct soap *soap, struct mons__ExeSwitchSMSToOther *p, const char *tag, const char *type)
{
	if ((p = soap_in_mons__ExeSwitchSMSToOther(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct mons__ExeSwitchSMSToOther * SOAP_FMAC2 soap_instantiate_mons__ExeSwitchSMSToOther(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_mons__ExeSwitchSMSToOther(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_mons__ExeSwitchSMSToOther, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct mons__ExeSwitchSMSToOther);
		if (size)
			*size = sizeof(struct mons__ExeSwitchSMSToOther);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct mons__ExeSwitchSMSToOther, n);
		if (size)
			*size = n * sizeof(struct mons__ExeSwitchSMSToOther);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct mons__ExeSwitchSMSToOther*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_mons__ExeSwitchSMSToOther(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct mons__ExeSwitchSMSToOther %p -> %p\n", q, p));
	*(struct mons__ExeSwitchSMSToOther*)p = *(struct mons__ExeSwitchSMSToOther*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_mons__ExeSwitchSMSToOtherResponse(struct soap *soap, struct mons__ExeSwitchSMSToOtherResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_int(soap, &a->ret);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_mons__ExeSwitchSMSToOtherResponse(struct soap *soap, const struct mons__ExeSwitchSMSToOtherResponse *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
#endif
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_mons__ExeSwitchSMSToOtherResponse(struct soap *soap, const char *tag, int id, const struct mons__ExeSwitchSMSToOtherResponse *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_mons__ExeSwitchSMSToOtherResponse), type))
		return soap->error;
	if (soap_out_int(soap, "ret", -1, &a->ret, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
SOAP_FMAC3 struct mons__ExeSwitchSMSToOtherResponse * SOAP_FMAC4 soap_in_mons__ExeSwitchSMSToOtherResponse(struct soap *soap, const char *tag, struct mons__ExeSwitchSMSToOtherResponse *a, const char *type)
{
	size_t soap_flag_ret = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct mons__ExeSwitchSMSToOtherResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_mons__ExeSwitchSMSToOtherResponse, sizeof(struct mons__ExeSwitchSMSToOtherResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_mons__ExeSwitchSMSToOtherResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct mons__ExeSwitchSMSToOtherResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_mons__ExeSwitchSMSToOtherResponse, 0, sizeof(struct mons__ExeSwitchSMSToOtherResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_ret > 0))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_mons__ExeSwitchSMSToOtherResponse(struct soap *soap, const struct mons__ExeSwitchSMSToOtherResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_mons__ExeSwitchSMSToOtherResponse);
	if (soap_out_mons__ExeSwitchSMSToOtherResponse(soap, tag?tag:"mons:ExeSwitchSMSToOtherResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct mons__ExeSwitchSMSToOtherResponse * SOAP_FMAC4 soap_get_mons__ExeSwitchSMSToOtherResponse(struct soap *soap, struct mons__ExeSwitchSMSToOtherResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_mons__ExeSwitchSMSToOtherResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct mons__ExeSwitchSMSToOtherResponse * SOAP_FMAC2 soap_instantiate_mons__ExeSwitchSMSToOtherResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_mons__ExeSwitchSMSToOtherResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_mons__ExeSwitchSMSToOtherResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct mons__ExeSwitchSMSToOtherResponse);
		if (size)
			*size = sizeof(struct mons__ExeSwitchSMSToOtherResponse);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct mons__ExeSwitchSMSToOtherResponse, n);
		if (size)
			*size = n * sizeof(struct mons__ExeSwitchSMSToOtherResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct mons__ExeSwitchSMSToOtherResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_mons__ExeSwitchSMSToOtherResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct mons__ExeSwitchSMSToOtherResponse %p -> %p\n", q, p));
	*(struct mons__ExeSwitchSMSToOtherResponse*)p = *(struct mons__ExeSwitchSMSToOtherResponse*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_mons__ExeSwitchTMSToOther(struct soap *soap, struct mons__ExeSwitchTMSToOther *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_mons__ExeSwitchTMSToOther(struct soap *soap, const struct mons__ExeSwitchTMSToOther *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
#endif
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_mons__ExeSwitchTMSToOther(struct soap *soap, const char *tag, int id, const struct mons__ExeSwitchTMSToOther *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_mons__ExeSwitchTMSToOther), type))
		return soap->error;
	return soap_element_end_out(soap, tag);
}

SOAP_FMAC3 struct mons__ExeSwitchTMSToOther * SOAP_FMAC4 soap_in_mons__ExeSwitchTMSToOther(struct soap *soap, const char *tag, struct mons__ExeSwitchTMSToOther *a, const char *type)
{
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct mons__ExeSwitchTMSToOther *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_mons__ExeSwitchTMSToOther, sizeof(struct mons__ExeSwitchTMSToOther), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_mons__ExeSwitchTMSToOther(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct mons__ExeSwitchTMSToOther *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_mons__ExeSwitchTMSToOther, 0, sizeof(struct mons__ExeSwitchTMSToOther), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_mons__ExeSwitchTMSToOther(struct soap *soap, const struct mons__ExeSwitchTMSToOther *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_mons__ExeSwitchTMSToOther);
	if (soap_out_mons__ExeSwitchTMSToOther(soap, tag?tag:"mons:ExeSwitchTMSToOther", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct mons__ExeSwitchTMSToOther * SOAP_FMAC4 soap_get_mons__ExeSwitchTMSToOther(struct soap *soap, struct mons__ExeSwitchTMSToOther *p, const char *tag, const char *type)
{
	if ((p = soap_in_mons__ExeSwitchTMSToOther(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct mons__ExeSwitchTMSToOther * SOAP_FMAC2 soap_instantiate_mons__ExeSwitchTMSToOther(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_mons__ExeSwitchTMSToOther(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_mons__ExeSwitchTMSToOther, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct mons__ExeSwitchTMSToOther);
		if (size)
			*size = sizeof(struct mons__ExeSwitchTMSToOther);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct mons__ExeSwitchTMSToOther, n);
		if (size)
			*size = n * sizeof(struct mons__ExeSwitchTMSToOther);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct mons__ExeSwitchTMSToOther*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_mons__ExeSwitchTMSToOther(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct mons__ExeSwitchTMSToOther %p -> %p\n", q, p));
	*(struct mons__ExeSwitchTMSToOther*)p = *(struct mons__ExeSwitchTMSToOther*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_mons__ExeSwitchTMSToOtherResponse(struct soap *soap, struct mons__ExeSwitchTMSToOtherResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_int(soap, &a->ret);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_mons__ExeSwitchTMSToOtherResponse(struct soap *soap, const struct mons__ExeSwitchTMSToOtherResponse *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
#endif
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_mons__ExeSwitchTMSToOtherResponse(struct soap *soap, const char *tag, int id, const struct mons__ExeSwitchTMSToOtherResponse *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_mons__ExeSwitchTMSToOtherResponse), type))
		return soap->error;
	if (soap_out_int(soap, "ret", -1, &a->ret, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
SOAP_FMAC3 struct mons__ExeSwitchTMSToOtherResponse * SOAP_FMAC4 soap_in_mons__ExeSwitchTMSToOtherResponse(struct soap *soap, const char *tag, struct mons__ExeSwitchTMSToOtherResponse *a, const char *type)
{
	size_t soap_flag_ret = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct mons__ExeSwitchTMSToOtherResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_mons__ExeSwitchTMSToOtherResponse, sizeof(struct mons__ExeSwitchTMSToOtherResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_mons__ExeSwitchTMSToOtherResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct mons__ExeSwitchTMSToOtherResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_mons__ExeSwitchTMSToOtherResponse, 0, sizeof(struct mons__ExeSwitchTMSToOtherResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_ret > 0))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_mons__ExeSwitchTMSToOtherResponse(struct soap *soap, const struct mons__ExeSwitchTMSToOtherResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_mons__ExeSwitchTMSToOtherResponse);
	if (soap_out_mons__ExeSwitchTMSToOtherResponse(soap, tag?tag:"mons:ExeSwitchTMSToOtherResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct mons__ExeSwitchTMSToOtherResponse * SOAP_FMAC4 soap_get_mons__ExeSwitchTMSToOtherResponse(struct soap *soap, struct mons__ExeSwitchTMSToOtherResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_mons__ExeSwitchTMSToOtherResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct mons__ExeSwitchTMSToOtherResponse * SOAP_FMAC2 soap_instantiate_mons__ExeSwitchTMSToOtherResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_mons__ExeSwitchTMSToOtherResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_mons__ExeSwitchTMSToOtherResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct mons__ExeSwitchTMSToOtherResponse);
		if (size)
			*size = sizeof(struct mons__ExeSwitchTMSToOtherResponse);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct mons__ExeSwitchTMSToOtherResponse, n);
		if (size)
			*size = n * sizeof(struct mons__ExeSwitchTMSToOtherResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct mons__ExeSwitchTMSToOtherResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_mons__ExeSwitchTMSToOtherResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct mons__ExeSwitchTMSToOtherResponse %p -> %p\n", q, p));
	*(struct mons__ExeSwitchTMSToOtherResponse*)p = *(struct mons__ExeSwitchTMSToOtherResponse*)q;
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_mons__GetEthStateResponse(struct soap *soap, struct mons__GetEthStateResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_std__vectorTemplateOfmons__ethstate(soap, &a->vecret);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_mons__GetEthStateResponse(struct soap *soap, const struct mons__GetEthStateResponse *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_std__vectorTemplateOfmons__ethstate(soap, &a->vecret);
#endif
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_mons__GetEthStateResponse(struct soap *soap, const char *tag, int id, const struct mons__GetEthStateResponse *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_mons__GetEthStateResponse), type))
		return soap->error;
	if (soap_out_std__vectorTemplateOfmons__ethstate(soap, "vecret", -1, &a->vecret, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}

SOAP_FMAC3 struct mons__GetEthStateResponse * SOAP_FMAC4 soap_in_mons__GetEthStateResponse(struct soap *soap, const char *tag, struct mons__GetEthStateResponse *a, const char *type)
{
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct mons__GetEthStateResponse *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE_mons__GetEthStateResponse, sizeof(struct mons__GetEthStateResponse), soap->type, soap->arrayType);
	if (!a)
		return NULL;
	soap_default_mons__GetEthStateResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_std__vectorTemplateOfmons__ethstate(soap, "vecret", &a->vecret, "mons:ethstate"))
					continue;
			if (soap->error == SOAP_TAG_MISMATCH)
				soap->error = soap_ignore_element(soap);
			if (soap->error == SOAP_NO_TAG)
	...
	{	a = (struct mons__GetEthStateResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_mons__GetEthStateResponse, 0, sizeof(struct mons__GetEthStateResponse), 0, soap_copy_mons__GetEthStateResponse);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (a->vecret.size() < 1))
	{	soap->error = SOAP_OCCURS;
		return NULL;
	}
	return a;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_mons__GetEthStateResponse(struct soap *soap, const struct mons__GetEthStateResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_mons__GetEthStateResponse);
	if (soap_out_mons__GetEthStateResponse(soap, tag?tag:"mons:GetEthStateResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct mons__GetEthStateResponse * SOAP_FMAC4 soap_get_mons__GetEthStateResponse(struct soap *soap, struct mons__GetEthStateResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_mons__GetEthStateResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct mons__GetEthStateResponse * SOAP_FMAC2 soap_instantiate_mons__GetEthStateResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_mons__GetEthStateResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_mons__GetEthStateResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct mons__GetEthStateResponse);
		if (size)
			*size = sizeof(struct mons__GetEthStateResponse);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct mons__GetEthStateResponse, n);
		if (size)
			*size = n * sizeof(struct mons__GetEthStateResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct mons__GetEthStateResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_mons__GetEthStateResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct mons__GetEthStateResponse %p -> %p\n", q, p));
	*(struct mons__GetEthStateResponse*)p = *(struct mons__GetEthStateResponse*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_mons__ethstate(struct soap *soap, struct mons__ethstate *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_int(soap, &a->eth);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_mons__ethstate(struct soap *soap, const char *tag, int id, const struct mons__ethstate *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_mons__ethstate), type))
		return soap->error;
	if (soap_out_int(soap, "eth", -1, &a->eth, ""))
		return soap->error;
...
SOAP_FMAC3 struct mons__ethstate * SOAP_FMAC4 soap_in_mons__ethstate(struct soap *soap, const char *tag, struct mons__ethstate *a, const char *type)
{
	...
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_eth && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_int(soap, "eth", &a->eth, "xsd:int"))
				{	soap_flag_eth--;
					continue;
				}
	...
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_eth > 0 || soap_flag_type > 0 || soap_flag_ConnectState > 0 || soap_flag_speed > 0))
	{	soap->error = SOAP_OCCURS;
		return NULL;
	}
	return a;
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_mons__GetSMSStateResponse(struct soap *soap, struct mons__GetSMSStateResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_std__vectorTemplateOfmons__SMSState(soap, &a->vecret);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_mons__GetSMSStateResponse(struct soap *soap, const struct mons__GetSMSStateResponse *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_std__vectorTemplateOfmons__SMSState(soap, &a->vecret);
#endif
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_mons__GetSMSStateResponse(struct soap *soap, const char *tag, int id, const struct mons__GetSMSStateResponse *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_mons__GetSMSStateResponse), type))
		return soap->error;
	if (soap_out_std__vectorTemplateOfmons__SMSState(soap, "vecret", -1, &a->vecret, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}

SOAP_FMAC3 struct mons__GetSMSStateResponse * SOAP_FMAC4 soap_in_mons__GetSMSStateResponse(struct soap *soap, const char *tag, struct mons__GetSMSStateResponse *a, const char *type)
{
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct mons__GetSMSStateResponse *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE_mons__GetSMSStateResponse, sizeof(struct mons__GetSMSStateResponse), soap->type, soap->arrayType);
	if (!a)
		return NULL;
	soap_default_mons__GetSMSStateResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_std__vectorTemplateOfmons__SMSState(soap, "vecret", &a->vecret, "mons:SMSState"))
					continue;
			if (soap->error == SOAP_TAG_MISMATCH)
				soap->error = soap_ignore_element(soap);
			if (soap->error == SOAP_NO_TAG)
	...
	{	a = (struct mons__GetSMSStateResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_mons__GetSMSStateResponse, 0, sizeof(struct mons__GetSMSStateResponse), 0, soap_copy_mons__GetSMSStateResponse);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (a->vecret.size() < 1))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_mons__GetSMSStateResponse(struct soap *soap, const struct mons__GetSMSStateResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_mons__GetSMSStateResponse);
	if (soap_out_mons__GetSMSStateResponse(soap, tag?tag:"mons:GetSMSStateResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct mons__GetSMSStateResponse * SOAP_FMAC4 soap_get_mons__GetSMSStateResponse(struct soap *soap, struct mons__GetSMSStateResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_mons__GetSMSStateResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct mons__GetSMSStateResponse * SOAP_FMAC2 soap_instantiate_mons__GetSMSStateResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_mons__GetSMSStateResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_mons__GetSMSStateResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct mons__GetSMSStateResponse);
		if (size)
			*size = sizeof(struct mons__GetSMSStateResponse);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct mons__GetSMSStateResponse, n);
		if (size)
			*size = n * sizeof(struct mons__GetSMSStateResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct mons__GetSMSStateResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_mons__GetSMSStateResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct mons__GetSMSStateResponse %p -> %p\n", q, p));
	*(struct mons__GetSMSStateResponse*)p = *(struct mons__GetSMSStateResponse*)q;
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_std__vectorTemplateOfmons__ethstate(struct soap *soap, std::vector<struct mons__ethstate >*p)
{
	p->clear();
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_std__vectorTemplateOfmons__ethstate(struct soap *soap, const std::vector<struct mons__ethstate >*a)
{
#ifndef WITH_NOIDREF
	for (std::vector<struct mons__ethstate >::const_iterator i = a->begin(); i != a->end(); ++i)
		soap_serialize_mons__ethstate(soap, &(*i));
#endif
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_std__vectorTemplateOfmons__ethstate(struct soap *soap, const char *tag, int id, const std::vector<struct mons__ethstate >*a, const char *type)
{
	for (std::vector<struct mons__ethstate >::const_iterator i = a->begin(); i != a->end(); ++i)
	{
		if (soap_out_mons__ethstate(soap, tag, id, &(*i), ""))
			return soap->error;
	}
	return SOAP_OK;
}

SOAP_FMAC3 std::vector<struct mons__ethstate >* SOAP_FMAC4 soap_in_std__vectorTemplateOfmons__ethstate(struct soap *soap, const char *tag, std::vector<struct mons__ethstate >*a, const char *type)
{
	(void)type; /* appease -Wall -Werror */
	short soap_flag;
	for (soap_flag = 0;; soap_flag = 1)
	{	struct mons__ethstate n;
		if (tag && *tag != '-')
		{	if (soap_element_begin_in(soap, tag, 1, NULL))
				break;
			soap_revert(soap);
		}
		soap_default_mons__ethstate(soap, &n);
		if (tag && *tag != '-' && (*soap->id || *soap->href))
		{	if (!soap_container_id_forward(soap, *soap->id?soap->id:soap->href, a, (size_t)a->size(), SOAP_TYPE_mons__ethstate, SOAP_TYPE_std__vectorTemplateOfmons__ethstate, sizeof(struct mons__ethstate), 0))
				break;
			if (!soap_in_mons__ethstate(soap, tag, NULL, "mons:ethstate"))
				break;
		}
		else if (!soap_in_mons__ethstate(soap, tag, &n, "mons:ethstate"))
			break;
		if (!a && !(a = soap_new_std__vectorTemplateOfmons__ethstate(soap, -1)))
			return NULL;
...
SOAP_FMAC1 std::vector<struct mons__ethstate > * SOAP_FMAC2 soap_instantiate_std__vectorTemplateOfmons__ethstate(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_std__vectorTemplateOfmons__ethstate(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_std__vectorTemplateOfmons__ethstate, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(std::vector<struct mons__ethstate >);
		if (size)
			*size = sizeof(std::vector<struct mons__ethstate >);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(std::vector<struct mons__ethstate >, n);
		if (size)
			*size = n * sizeof(std::vector<struct mons__ethstate >);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (std::vector<struct mons__ethstate >*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_std__vectorTemplateOfmons__ethstate(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying std::vector<struct mons__ethstate > %p -> %p\n", q, p));
	*(std::vector<struct mons__ethstate >*)p = *(std::vector<struct mons__ethstate >*)q;
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_std__vectorTemplateOfmons__SMSState(struct soap *soap, std::vector<struct mons__SMSState >*p)
{
	p->clear();
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_std__vectorTemplateOfmons__SMSState(struct soap *soap, const std::vector<struct mons__SMSState >*a)
{
#ifndef WITH_NOIDREF
	for (std::vector<struct mons__SMSState >::const_iterator i = a->begin(); i != a->end(); ++i)
		soap_serialize_mons__SMSState(soap, &(*i));
#endif
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_std__vectorTemplateOfmons__SMSState(struct soap *soap, const char *tag, int id, const std::vector<struct mons__SMSState >*a, const char *type)
{
	for (std::vector<struct mons__SMSState >::const_iterator i = a->begin(); i != a->end(); ++i)
	{
		if (soap_out_mons__SMSState(soap, tag, id, &(*i), ""))
			return soap->error;
	}
	return SOAP_OK;
}

SOAP_FMAC3 std::vector<struct mons__SMSState >* SOAP_FMAC4 soap_in_std__vectorTemplateOfmons__SMSState(struct soap *soap, const char *tag, std::vector<struct mons__SMSState >*a, const char *type)
{
	(void)type; /* appease -Wall -Werror */
	short soap_flag;
	for (soap_flag = 0;; soap_flag = 1)
	{	struct mons__SMSState n;
		if (tag && *tag != '-')
		{	if (soap_element_begin_in(soap, tag, 1, NULL))
				break;
			soap_revert(soap);
		}
		soap_default_mons__SMSState(soap, &n);
		if (tag && *tag != '-' && (*soap->id || *soap->href))
		{	if (!soap_container_id_forward(soap, *soap->id?soap->id:soap->href, a, (size_t)a->size(), SOAP_TYPE_mons__SMSState, SOAP_TYPE_std__vectorTemplateOfmons__SMSState, sizeof(struct mons__SMSState), 0))
				break;
			if (!soap_in_mons__SMSState(soap, tag, NULL, "mons:SMSState"))
				break;
		}
		else if (!soap_in_mons__SMSState(soap, tag, &n, "mons:SMSState"))
			break;
		if (!a && !(a = soap_new_std__vectorTemplateOfmons__SMSState(soap, -1)))
			return NULL;
		soap_update_pointers(soap, (char*)&n, (char*)&n + sizeof(n), (char*)&(*a->insert(a->end(), n)), (char*)&n);
		if (!tag || *tag == '-')
			return a;
...
SOAP_FMAC1 std::vector<struct mons__SMSState > * SOAP_FMAC2 soap_instantiate_std__vectorTemplateOfmons__SMSState(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_std__vectorTemplateOfmons__SMSState(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_std__vectorTemplateOfmons__SMSState, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(std::vector<struct mons__SMSState >);
		if (size)
			*size = sizeof(std::vector<struct mons__SMSState >);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(std::vector<struct mons__SMSState >, n);
		if (size)
			*size = n * sizeof(std::vector<struct mons__SMSState >);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (std::vector<struct mons__SMSState >*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_std__vectorTemplateOfmons__SMSState(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying std::vector<struct mons__SMSState > %p -> %p\n", q, p));
	*(std::vector<struct mons__SMSState >*)p = *(std::vector<struct mons__SMSState >*)q;
}
