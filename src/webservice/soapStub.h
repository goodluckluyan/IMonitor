...
{
public:
	int soap_type() const { return 20; } /* = unique type id SOAP_TYPE_mons__GetSMSState */
#ifdef WITH_NOEMPTYSTRUCT
private:
	char dummy;	/* dummy member to enable compilation */
#endif
...
public:
	int soap_type() const { return 21; } /* = unique type id SOAP_TYPE_mons__RaidStateRes */
};
#endif
...
{
public:
	int soap_type() const { return 25; } /* = unique type id SOAP_TYPE_mons__GetRaidtate */
#ifdef WITH_NOEMPTYSTRUCT
private:
	char dummy;	/* dummy member to enable compilation */
#endif
...
{
public:
	int ConnectState;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* required element of type xsd:int */
	int speed;	/* required element of type xsd:int */
public:
	int soap_type() const { return 26; } /* = unique type id SOAP_TYPE_mons__ethstate */
};
#endif

#ifndef SOAP_TYPE_mons__GetEthState
#define SOAP_TYPE_mons__GetEthState (29)
/* mons:GetEthState */
struct mons__GetEthState
{
public:
	int soap_type() const { return 29; } /* = unique type id SOAP_TYPE_mons__GetEthState */
#ifdef WITH_NOEMPTYSTRUCT
private:
	char dummy;	/* dummy member to enable compilation */
#endif
...
#define SOAP_TYPE_mons__SwitchStateRes (30)
/* mons:SwitchStateRes */
...
public:
	int soap_type() const { return 30; } /* = unique type id SOAP_TYPE_mons__SwitchStateRes */
};
#endif

#ifndef SOAP_TYPE_mons__GetSwitchState
#define SOAP_TYPE_mons__GetSwitchState (33)
/* mons:GetSwitchState */
struct mons__GetSwitchState
{
public:
	int soap_type() const { return 33; } /* = unique type id SOAP_TYPE_mons__GetSwitchState */
#ifdef WITH_NOEMPTYSTRUCT
private:
	char dummy;	/* dummy member to enable compilation */
#endif
...
#define SOAP_TYPE_mons__IngestSpeedLimitRes (34)
...
public:
	int soap_type() const { return 34; } /* = unique type id SOAP_TYPE_mons__IngestSpeedLimitRes */
};
#endif

#ifndef SOAP_TYPE_mons__GetIngestSpeedLimit
#define SOAP_TYPE_mons__GetIngestSpeedLimit (37)
/* mons:GetIngestSpeedLimit */
struct mons__GetIngestSpeedLimit
{
public:
	int soap_type() const { return 37; } /* = unique type id SOAP_TYPE_mons__GetIngestSpeedLimit */
#ifdef WITH_NOEMPTYSTRUCT
private:
	char dummy;	/* dummy member to enable compilation */
#endif
...
#define SOAP_TYPE_mons__WorkStateRes (38)
/* mons:WorkStateRes */
...
public:
	int soap_type() const { return 38; } /* = unique type id SOAP_TYPE_mons__WorkStateRes */
};
#endif

#ifndef SOAP_TYPE_mons__GetWorkState_USCORECS
#define SOAP_TYPE_mons__GetWorkState_USCORECS (41)
/* mons:GetWorkState_CS */
struct mons__GetWorkState_USCORECS
{
public:
	int soap_type() const { return 41; } /* = unique type id SOAP_TYPE_mons__GetWorkState_USCORECS */
#ifdef WITH_NOEMPTYSTRUCT
private:
	char dummy;	/* dummy member to enable compilation */
#endif
...
public:
	int soap_type() const { return 43; } /* = unique type id SOAP_TYPE_SOAP_ENV__Code */
};
#endif
...
public:
	int soap_type() const { return 45; } /* = unique type id SOAP_TYPE_SOAP_ENV__Detail */
};
#endif
...
public:
	int soap_type() const { return 49; } /* = unique type id SOAP_TYPE_SOAP_ENV__Fault */
};
#endif
...
SOAP_FMAC5 int SOAP_FMAC6 mons__GetEthState(struct soap*, struct mons__ethstate &ret);
