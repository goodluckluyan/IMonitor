...
{
public:
	std::string eth;	/* required element of type xsd:string */
...
public:
	int soap_type() const { return 30; } /* = unique type id SOAP_TYPE_mons__GetEthStateResponse */
};
#endif
...
{
public:
	int soap_type() const { return 31; } /* = unique type id SOAP_TYPE_mons__GetEthState */
#ifdef WITH_NOEMPTYSTRUCT
private:
	char dummy;	/* dummy member to enable compilation */
#endif
...
public:
	int soap_type() const { return 32; } /* = unique type id SOAP_TYPE_mons__SwitchStateRes */
};
#endif
...
{
public:
	int soap_type() const { return 35; } /* = unique type id SOAP_TYPE_mons__GetSwitchState */
#ifdef WITH_NOEMPTYSTRUCT
private:
	char dummy;	/* dummy member to enable compilation */
#endif
...
public:
	int soap_type() const { return 36; } /* = unique type id SOAP_TYPE_mons__IngestSpeedLimitRes */
};
#endif
...
{
public:
	int soap_type() const { return 39; } /* = unique type id SOAP_TYPE_mons__GetIngestSpeedLimit */
#ifdef WITH_NOEMPTYSTRUCT
private:
	char dummy;	/* dummy member to enable compilation */
#endif
...
public:
	int soap_type() const { return 40; } /* = unique type id SOAP_TYPE_mons__WorkStateRes */
};
#endif
...
{
public:
	int soap_type() const { return 43; } /* = unique type id SOAP_TYPE_mons__GetWorkState_USCORECS */
#ifdef WITH_NOEMPTYSTRUCT
private:
	char dummy;	/* dummy member to enable compilation */
#endif
