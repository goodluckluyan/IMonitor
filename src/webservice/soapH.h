...
inline struct mons__ethstate * soap_new_req_mons__ethstate(struct soap *soap, int ConnectState, int speed) { struct mons__ethstate *_p = soap_instantiate_mons__ethstate(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_mons__ethstate(soap, _p); _p->ConnectState = ConnectState; _p->speed = speed; } return _p; }

inline struct mons__ethstate * soap_new_set_mons__ethstate(struct soap *soap, int ConnectState, int speed) { struct mons__ethstate *_p = soap_instantiate_mons__ethstate(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_mons__ethstate(soap, _p); _p->ConnectState = ConnectState; _p->speed = speed; } return _p; }
