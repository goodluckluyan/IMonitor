...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_mons__ExeGetHashCheckPercent(struct soap*, struct mons__ExeGetHashCheckPercent *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_mons__ExeGetHashCheckPercent(struct soap*, const struct mons__ExeGetHashCheckPercent *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_mons__ExeGetHashCheckPercent(struct soap*, const char*, int, const struct mons__ExeGetHashCheckPercent *, const char*);
SOAP_FMAC3 struct mons__ExeGetHashCheckPercent * SOAP_FMAC4 soap_in_mons__ExeGetHashCheckPercent(struct soap*, const char*, struct mons__ExeGetHashCheckPercent *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put_mons__ExeGetHashCheckPercent(struct soap*, const struct mons__ExeGetHashCheckPercent *, const char*, const char*);

#ifndef soap_write_mons__ExeGetHashCheckPercent
#define soap_write_mons__ExeGetHashCheckPercent(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_mons__ExeGetHashCheckPercent(soap, data),0) || soap_put_mons__ExeGetHashCheckPercent(soap, data, "mons:ExeGetHashCheckPercent", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct mons__ExeGetHashCheckPercent * SOAP_FMAC4 soap_get_mons__ExeGetHashCheckPercent(struct soap*, struct mons__ExeGetHashCheckPercent *, const char*, const char*);

#ifndef soap_read_mons__ExeGetHashCheckPercent
#define soap_read_mons__ExeGetHashCheckPercent(soap, data) ( soap_begin_recv(soap) || !soap_get_mons__ExeGetHashCheckPercent(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 struct mons__ExeGetHashCheckPercent * SOAP_FMAC2 soap_instantiate_mons__ExeGetHashCheckPercent(struct soap*, int, const char*, const char*, size_t*);

inline struct mons__ExeGetHashCheckPercent * soap_new_mons__ExeGetHashCheckPercent(struct soap *soap, int n = -1) { return soap_instantiate_mons__ExeGetHashCheckPercent(soap, n, NULL, NULL, NULL); }

inline struct mons__ExeGetHashCheckPercent * soap_new_req_mons__ExeGetHashCheckPercent(struct soap *soap, std::string& PklUuid) { struct mons__ExeGetHashCheckPercent *_p = soap_instantiate_mons__ExeGetHashCheckPercent(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_mons__ExeGetHashCheckPercent(soap, _p); _p->PklUuid = PklUuid; } return _p; }

inline struct mons__ExeGetHashCheckPercent * soap_new_set_mons__ExeGetHashCheckPercent(struct soap *soap, std::string& PklUuid) { struct mons__ExeGetHashCheckPercent *_p = soap_instantiate_mons__ExeGetHashCheckPercent(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_mons__ExeGetHashCheckPercent(soap, _p); _p->PklUuid = PklUuid; } return _p; }

inline void soap_delete_mons__ExeGetHashCheckPercent(struct soap *soap, struct mons__ExeGetHashCheckPercent *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_mons__ExeGetHashCheckPercent(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_mons__HashCheckPercent
#define SOAP_TYPE_mons__HashCheckPercent (66)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_mons__HashCheckPercent(struct soap*, struct mons__HashCheckPercent *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_mons__HashCheckPercent(struct soap*, const struct mons__HashCheckPercent *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_mons__HashCheckPercent(struct soap*, const char*, int, const struct mons__HashCheckPercent *, const char*);
SOAP_FMAC3 struct mons__HashCheckPercent * SOAP_FMAC4 soap_in_mons__HashCheckPercent(struct soap*, const char*, struct mons__HashCheckPercent *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put_mons__HashCheckPercent(struct soap*, const struct mons__HashCheckPercent *, const char*, const char*);

#ifndef soap_write_mons__HashCheckPercent
#define soap_write_mons__HashCheckPercent(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_mons__HashCheckPercent(soap, data),0) || soap_put_mons__HashCheckPercent(soap, data, "mons:HashCheckPercent", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct mons__HashCheckPercent * SOAP_FMAC4 soap_get_mons__HashCheckPercent(struct soap*, struct mons__HashCheckPercent *, const char*, const char*);

#ifndef soap_read_mons__HashCheckPercent
#define soap_read_mons__HashCheckPercent(soap, data) ( soap_begin_recv(soap) || !soap_get_mons__HashCheckPercent(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 struct mons__HashCheckPercent * SOAP_FMAC2 soap_instantiate_mons__HashCheckPercent(struct soap*, int, const char*, const char*, size_t*);

inline struct mons__HashCheckPercent * soap_new_mons__HashCheckPercent(struct soap *soap, int n = -1) { return soap_instantiate_mons__HashCheckPercent(soap, n, NULL, NULL, NULL); }

inline struct mons__HashCheckPercent * soap_new_req_mons__HashCheckPercent(struct soap *soap, int Result, int nPercent, std::string& errorInfo) { struct mons__HashCheckPercent *_p = soap_instantiate_mons__HashCheckPercent(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_mons__HashCheckPercent(soap, _p); _p->Result = Result; _p->nPercent = nPercent; _p->errorInfo = errorInfo; } return _p; }

inline struct mons__HashCheckPercent * soap_new_set_mons__HashCheckPercent(struct soap *soap, int Result, int nPercent, std::string& errorInfo) { struct mons__HashCheckPercent *_p = soap_instantiate_mons__HashCheckPercent(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_mons__HashCheckPercent(soap, _p); _p->Result = Result; _p->nPercent = nPercent; _p->errorInfo = errorInfo; } return _p; }

inline void soap_delete_mons__HashCheckPercent(struct soap *soap, struct mons__HashCheckPercent *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_mons__HashCheckPercent(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_mons__ExeDcpHashCheck
#define SOAP_TYPE_mons__ExeDcpHashCheck (65)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_mons__ExeDcpHashCheck(struct soap*, struct mons__ExeDcpHashCheck *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_mons__ExeDcpHashCheck(struct soap*, const struct mons__ExeDcpHashCheck *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_mons__ExeDcpHashCheck(struct soap*, const char*, int, const struct mons__ExeDcpHashCheck *, const char*);
SOAP_FMAC3 struct mons__ExeDcpHashCheck * SOAP_FMAC4 soap_in_mons__ExeDcpHashCheck(struct soap*, const char*, struct mons__ExeDcpHashCheck *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put_mons__ExeDcpHashCheck(struct soap*, const struct mons__ExeDcpHashCheck *, const char*, const char*);

#ifndef soap_write_mons__ExeDcpHashCheck
#define soap_write_mons__ExeDcpHashCheck(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_mons__ExeDcpHashCheck(soap, data),0) || soap_put_mons__ExeDcpHashCheck(soap, data, "mons:ExeDcpHashCheck", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct mons__ExeDcpHashCheck * SOAP_FMAC4 soap_get_mons__ExeDcpHashCheck(struct soap*, struct mons__ExeDcpHashCheck *, const char*, const char*);

#ifndef soap_read_mons__ExeDcpHashCheck
#define soap_read_mons__ExeDcpHashCheck(soap, data) ( soap_begin_recv(soap) || !soap_get_mons__ExeDcpHashCheck(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 struct mons__ExeDcpHashCheck * SOAP_FMAC2 soap_instantiate_mons__ExeDcpHashCheck(struct soap*, int, const char*, const char*, size_t*);

inline struct mons__ExeDcpHashCheck * soap_new_mons__ExeDcpHashCheck(struct soap *soap, int n = -1) { return soap_instantiate_mons__ExeDcpHashCheck(soap, n, NULL, NULL, NULL); }

inline struct mons__ExeDcpHashCheck * soap_new_req_mons__ExeDcpHashCheck(struct soap *soap, std::string& path, std::string& PklUuid) { struct mons__ExeDcpHashCheck *_p = soap_instantiate_mons__ExeDcpHashCheck(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_mons__ExeDcpHashCheck(soap, _p); _p->path = path; _p->PklUuid = PklUuid; } return _p; }

inline struct mons__ExeDcpHashCheck * soap_new_set_mons__ExeDcpHashCheck(struct soap *soap, std::string& path, std::string& PklUuid) { struct mons__ExeDcpHashCheck *_p = soap_instantiate_mons__ExeDcpHashCheck(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_mons__ExeDcpHashCheck(soap, _p); _p->path = path; _p->PklUuid = PklUuid; } return _p; }

inline void soap_delete_mons__ExeDcpHashCheck(struct soap *soap, struct mons__ExeDcpHashCheck *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_mons__ExeDcpHashCheck(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_mons__ExeDcpHashCheckResponse
#define SOAP_TYPE_mons__ExeDcpHashCheckResponse (64)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_mons__ExeDcpHashCheckResponse(struct soap*, struct mons__ExeDcpHashCheckResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_mons__ExeDcpHashCheckResponse(struct soap*, const struct mons__ExeDcpHashCheckResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_mons__ExeDcpHashCheckResponse(struct soap*, const char*, int, const struct mons__ExeDcpHashCheckResponse *, const char*);
SOAP_FMAC3 struct mons__ExeDcpHashCheckResponse * SOAP_FMAC4 soap_in_mons__ExeDcpHashCheckResponse(struct soap*, const char*, struct mons__ExeDcpHashCheckResponse *, const char*);

SOAP_FMAC3 int SOAP_FMAC4 soap_put_mons__ExeDcpHashCheckResponse(struct soap*, const struct mons__ExeDcpHashCheckResponse *, const char*, const char*);

#ifndef soap_write_mons__ExeDcpHashCheckResponse
#define soap_write_mons__ExeDcpHashCheckResponse(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_mons__ExeDcpHashCheckResponse(soap, data),0) || soap_put_mons__ExeDcpHashCheckResponse(soap, data, "mons:ExeDcpHashCheckResponse", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct mons__ExeDcpHashCheckResponse * SOAP_FMAC4 soap_get_mons__ExeDcpHashCheckResponse(struct soap*, struct mons__ExeDcpHashCheckResponse *, const char*, const char*);

#ifndef soap_read_mons__ExeDcpHashCheckResponse
#define soap_read_mons__ExeDcpHashCheckResponse(soap, data) ( soap_begin_recv(soap) || !soap_get_mons__ExeDcpHashCheckResponse(soap, data, NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

SOAP_FMAC1 struct mons__ExeDcpHashCheckResponse * SOAP_FMAC2 soap_instantiate_mons__ExeDcpHashCheckResponse(struct soap*, int, const char*, const char*, size_t*);

inline struct mons__ExeDcpHashCheckResponse * soap_new_mons__ExeDcpHashCheckResponse(struct soap *soap, int n = -1) { return soap_instantiate_mons__ExeDcpHashCheckResponse(soap, n, NULL, NULL, NULL); }

inline struct mons__ExeDcpHashCheckResponse * soap_new_req_mons__ExeDcpHashCheckResponse(struct soap *soap, std::string& errorInfo) { struct mons__ExeDcpHashCheckResponse *_p = soap_instantiate_mons__ExeDcpHashCheckResponse(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_mons__ExeDcpHashCheckResponse(soap, _p); _p->errorInfo = errorInfo; } return _p; }

inline struct mons__ExeDcpHashCheckResponse * soap_new_set_mons__ExeDcpHashCheckResponse(struct soap *soap, std::string& errorInfo) { struct mons__ExeDcpHashCheckResponse *_p = soap_instantiate_mons__ExeDcpHashCheckResponse(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_mons__ExeDcpHashCheckResponse(soap, _p); _p->errorInfo = errorInfo; } return _p; }

inline void soap_delete_mons__ExeDcpHashCheckResponse(struct soap *soap, struct mons__ExeDcpHashCheckResponse *p) { soap_delete(soap, p); }

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_mons__ExeDcpHashCheckResponse(struct soap*, int, int, void*, size_t, const void*, size_t);
